...
def index(request):
    ...
    num_books_hi = Book.objects.filter(title__icontains='t').count()
...
def sliders(request):
    ...
    return render(request, "catalog/sliders.html", context)
...
def slider2(request):
    ...
    return render(request, "catalog/sliders.html", {"the_script2":script,"the_div2":div})
